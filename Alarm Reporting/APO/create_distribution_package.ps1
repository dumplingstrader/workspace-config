<#
.SYNOPSIS
    Creates a timestamped distribution package (ZIP) from current directory contents
.DESCRIPTION
...
.EXAMPLE
    .\create_distribution_package.ps1 -PackageName "MyProject" -ItemsToInclude @("docs", "scripts", "README.md")
    Creates package with specific name and items
.NOTES
    Created: January 27, 2026
    Purpose: Reusable distribution package creator
#>
...
$(foreach ($item in $ItemsToInclude) { "- $item`n" })

For more information, please refer to the documentation within this package.
"@
